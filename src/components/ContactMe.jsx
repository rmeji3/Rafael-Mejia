...
function ContactMe() {
    return (
        <div id="contact-me" className='bg-white d-flex flex-column gap-2' style={{ marginLeft: '-7rem', marginRight: '-7rem',paddingTop: '2rem'}}>
            <a href="mailto:Rafaelm120403@gmail.com" className="fw-semibold text-center responsive-heading" style={{ color: '#0C0F19', textDecoration: 'none' }}>
                Rafaelm120403@gmail.com
            </a>
            {/* circle */}
            <a  href="tel:+17089429844" className='fw-semibold text-center d-block responsive-subheading' style={{ textDecoration: 'none', color: '#0C0F19' }}>+1 (708) 942-9844</a>
                ...
                <p className='text-center pt-4' style={{ fontSize: '0.9rem' }}>By Rafael Mejia</p>
        </div>
    );
}
